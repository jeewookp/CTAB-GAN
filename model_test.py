...
# optimizer = torch.optim.Adam(classifier.fc1.parameters(), lr=1e-3)
optimizer = torch.optim.Adam(list(classifier.fc0.parameters())[1:]+list(classifier.fc1.parameters()), lr=1e-3)
criterion = nn.CrossEntropyLoss()
